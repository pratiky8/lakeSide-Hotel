...
const BookingSummary = ({booking, payment, isFormValid, onConfirm}) => {
  ...
  return (
    <div className='card card-body mt-5'>
        ...
        <p>
        Check-In Date : <strong>{moment(booking.checkInDate).format("Do MMM YYYY")}</strong>
        </p>
        <p>
        Check-Out Date : <strong>{moment(booking.checkOutDate).format("Do MMM YYYY")}</strong>
        </p>
        <p>
        ...
        {payment > 0 ? (
            ...
            {isFormValid && !isBookingConfirmed ? (
                ...
                <div className='d-flex justify-content-center align-items-center'>
                    <div className='spinner-border test-primary' role='status'>
